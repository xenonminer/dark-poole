...
| % : go back and forth across a pair of chars (() [] {}) <br /> Only in current line<br />&emsp;t : jump to the right before the char in the line <br />&emsp;f : jump to on the char in the line<br />&emsp;Shift + t : same as t but backwards<br />&emsp;Shift + f : same as f but backwards<br /> gg : jump to beginning of file<br /> Shift + g : jump to end of file<br /> <line number> + Shift + g : jump to line number | Jumping/Finding text |  |
