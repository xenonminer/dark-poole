...
| % : go back and forth across a pair of chars (() [] {}) <br /> Only in current line<br />t : jump to the right before the char in the line <br />f : jump to on the char in the line<br />Shift + t : same as t but backwards<br /> Shift + f : same as f but backwards<br /> gg : jump to beginning of file<br /> Shift + g : jump to end of file<br /> <line number> + Shift + g : jump to line number | Jumping/Finding text |  |
...
| m<character> : creates a waypoint to that lin<br />'<character> : goes to that waypoint<br />:marks : view all waypoints | Vim waypoints (like a portal back to a certain registered waypoint) (can also be through different files) |  |
